...
class DreamPoseDataset(Dataset):
    ...
    def __init__(
        ...
        self.instance_images_path = glob.glob(instance_data_root+'/*jpeg')
    ...
    def __getitem__(self, index):
        ...
        frame_paths = glob.glob(frame_folder+'/*jpeg')
        frame_paths = [p for p in frame_paths if os.path.exists(p.replace('.jpeg', '_densepose.npy'))]
        ...
        for pose_number in range(5):
            dp_path = frame_j_path.replace('.jpeg', '_densepose.npy')
